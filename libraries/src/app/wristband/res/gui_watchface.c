...
#define HOUR_HEIGHT            61
#define HOUR_WIDTH             8
#define HOUR_CENTER_HEIGHT     59
#define MIN_HEIGHT             90
#define MIN_WIDTH              8
#define MIN_CENTER_HEIGHT      89
#define SEC_HEIGHT             133
#define SEC_WIDTH              11
#define SEC_CENTER_HEIGHT      102
...
const static UI_WidgetTypeDef  icon[] =
{
    ...
    [4]     = {
        ...
        .u.clock_pointer.rotation_cosa = 1.0f, .u.clock_pointer.rotation_sina = 0.0f, .u.clock_pointer.center_x = 120, .u.clock_pointer.center_y = 120, .u.clock_pointer.source_pic_width = HOUR_WIDTH, .u.clock_pointer.source_pic_height = HOUR_HEIGHT, \
    ...
    [5]     = {
        ...
        .u.clock_pointer.rotation_cosa = 1.0f, .u.clock_pointer.rotation_sina = 0.0f, .u.clock_pointer.center_x = 120, .u.clock_pointer.center_y = 120, .u.clock_pointer.source_pic_width = MIN_WIDTH, .u.clock_pointer.source_pic_height = MIN_HEIGHT, \
    ...
    [6]     = {
        ...
        .u.clock_pointer.rotation_cosa = 1.0f, .u.clock_pointer.rotation_sina = 0.0f, .u.clock_pointer.center_x = 120, .u.clock_pointer.center_y = 120, .u.clock_pointer.source_pic_width = SEC_WIDTH, .u.clock_pointer.source_pic_height = SEC_HEIGHT, \
        .u.clock_pointer.source_pic_center_height = SEC_CENTER_HEIGHT,
    },
};

UI_MenuTypeDef WatchFaceAWMenu =
{
    .name = (const char *)"WatchFaceAWMenu",
    .MenuParent = NULL,
    .MenuSub = NULL,
...
static void TimerCallbackFun(RtkGuiTimerInfo_t *timer_info)
{
    ...
    if (memcmp(timer_info->menu_name,  WatchFaceAWMenu.name, strlen(WatchFaceAWMenu.name)))
    {
        return;
    }
    ...
    else if ((timer_id == 2) && (display_timer != NULL))
    {
        ...
        {
            rtl_gui_menu_update(&WatchFaceAWMenu, NULL, NULL, NULL, &ExerciseMenu, NULL, 0, 0);
        }
#endif
    }
...
static void ConstructorCallbackFun(uint32_t type, void *pValue)
{
    ...
    rtl_gui_menu_update(&WatchFaceAWMenu, NULL, NULL, NULL, NULL, NULL, 0, 0);
...
static void TouchCallbackFun(RtkTouchInfo_t *info)
{
    ...
    UI_MenuTypeDef *ui_local_left = &BTInquiryUIMenu;
    UI_MenuTypeDef *ui_local_cur = &WatchFaceAWMenu;
