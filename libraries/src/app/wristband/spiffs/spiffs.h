...
#if SPIFFS_HAL_CALLBACK_EXTRA
typedef void (*spiffs_check_callback)(struct spiffs_t *fs, spiffs_check_type type,
...
typedef void (*spiffs_file_callback)(struct spiffs_t *fs, spiffs_fileop_type op,
