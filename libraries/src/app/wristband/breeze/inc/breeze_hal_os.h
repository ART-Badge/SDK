 ...
 * @return  0: success.
 */
int breeze_os_timer_new(os_timer_t *timer, os_timer_cb_t cb, void *arg, int ms);
 ...
 * @return  0: success.
 */
int breeze_os_timer_start(os_timer_t *timer);
 ...
 * @return  0: success.
 */
int breeze_os_timer_stop(os_timer_t *timer);
 ...
 */
void breeze_os_timer_free(os_timer_t *timer);

/**
 * Reboot system.
 */
void breeze_os_reboot(void);
 ...
 */
long long breeze_os_now_ms(void);
/**
 * Add a new KV pair.
 *
