...
static const T_ATTRIB_APPL hids_attr_tbl[] =
{
    ...
    /*  HID report map characteristic value .. 4*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* wFlags */
        {                                           /* bTypeValue */
    ...
    /*  HID boot keyboard input characteristic value .. 7*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* flags */
        {                                           /* type_value */
    ...
    /*  HID boot keyboard output characteristic value .. 10*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* flags */
        {                                           /* type_value */
    ...
    /*  HID Information characteristic value .. 12*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* wFlags */
        {                                           /* bTypeValue */
    ...
    /*  HID controlPoint characteristic value .. 14*/
    {
        ATTRIB_FLAG_VALUE_APPL,                     /* wFlags */
        {                                           /* bTypeValue */
    ...
    /*  HID Report characteristic value ,multimedia keyboard Input 16*/
    {
        ATTRIB_FLAG_VALUE_APPL,                   /* wFlags */
        {                                         /* bTypeValue */
    ...
    /* client characteristic configuration 17*/
    {
        (ATTRIB_FLAG_VALUE_INCL |                   /* wFlags */
    ...
    /*report ID map reference descriptor 18*/
    {
        (ATTRIB_FLAG_VALUE_INCL |                   /* wFlags */
         ATTRIB_FLAG_CCCD_APPL),
        {                                           /* bTypeValue */
...
void hids_cccd_update_cb(uint8_t conn_id, T_SERVER_ID service_id, uint16_t index, uint16_t ccc_bits)
{
    ...
    case GATT_SVC_HID_MM_IN_REPORT_CCCD_INDEX:
        {
            callback_data.msg_data.not_ind_data.index = GATT_SVC_HID_MM_IN_REPORT_CCCD_INDEX;
