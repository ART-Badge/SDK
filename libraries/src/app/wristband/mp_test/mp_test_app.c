...
/** @addtogroup  PERIPH_SEVER_CALLBACK Profile Server Callback Event Handler
    ...
    * @{
    */
T_SERVER_ID mp_test_simp_srv_id; /**< Simple ble service id*/
T_SERVER_ID mp_test_bas_srv_id;  /**< Battery service id */
 ...
 *                              Functions
 *============================================================================*/
static void app_handle_gap_msg(T_IO_MSG  *p_gap_msg);
/**
...
void mp_test_task_handle_io_msg(T_IO_MSG io_msg)
{
    ...
    uint16_t sub_type = io_msg.subtype;
            ...
            case 0:
                {
                    ...
                    {
                        simp_ble_service_send_v3_notify(0, mp_test_simp_srv_id, test_pattern, 128);
                        simp_ble_service_send_v3_notify(0, mp_test_simp_srv_id, test_pattern + 128, 128);
                    }
                    break;
                }
            default:
...
//                test_pattern[i] = i;
//            }
//            simp_ble_service_send_v3_notify(conn_id, mp_test_simp_srv_id, test_pattern, 10);
        }
        break;
...
T_APP_RESULT mp_test_task_profile_callback(T_SERVER_ID service_id, void *p_data)
{
    ...
    else  if (service_id == mp_test_simp_srv_id)
    {
                ...
                case SIMP_NOTIFY_INDICATE_V3_ENABLE:
                    {
                        ...
                        os_timer_start(&mp_test_connect_timer);
                    }
                    break;
    ...
    else if (service_id == mp_test_bas_srv_id)
    {
