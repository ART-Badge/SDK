...
struct fdb_db {
    ...
    const struct fal_partition *fastfs_part;     /**< fastfs flash partition for saving database */
    uint32_t fastfs_file_offset;                 /**< fastfs file offset addr */
    bool is_fastfs;                              /**< is fastfs, default is false */
#endif
