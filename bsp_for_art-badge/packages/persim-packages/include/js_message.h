...
typedef void (*js_message_send_func)(const char *name, const rt_uint8_t *data, rt_uint32_t size);

void js_message_send_func_init(js_message_send_func func);
rt_bool_t js_message_send(const char *name, const rt_uint8_t *data, rt_uint32_t size);
