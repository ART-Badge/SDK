...
#define RT_DEVICE_CTRL_RTC_GET_TIMEVAL  0x12            /**< get timeval for gettimeofday */
#define RT_DEVICE_CTRL_RTC_SET_TIMEVAL  0x13            /**< set timeval for gettimeofday */
