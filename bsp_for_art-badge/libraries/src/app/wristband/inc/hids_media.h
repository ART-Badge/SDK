...
#ifndef _HIDS_MEDIA_H_
#define _HIDS_MEDIA_H_
...
#define GATT_SVC_HID_REPORT_MAP_INDEX               (4)
#define GATT_SVC_HID_EXTERNAL_REPORT_REFER_INDEX    (GATT_SVC_HID_REPORT_MAP_INDEX+1)
#define GATT_SVC_HID_BOOT_KB_IN_REPORT_INDEX        (7)
#define GATT_SVC_HID_BOOT_KB_IN_REPORT_CCCD_INDEX   (GATT_SVC_HID_BOOT_KB_IN_REPORT_INDEX+1)
#define GATT_SVC_HID_BOOT_KB_OUT_REPORT_INDEX       (10)
#define GATT_SVC_HID_INFO_INDEX                     (12)
#define GATT_SVC_HID_CONTROL_POINT_INDEX            (14)
#define GATT_SVC_HID_MM_IN_REPORT_INDEX             (16)
#define GATT_SVC_HID_MM_IN_REPORT_CCCD_INDEX        (GATT_SVC_HID_MM_IN_REPORT_INDEX+1)
/** @} */
