...
#define     TEST390_0_NUM_0_BIN    (0x1000000 + 0)
#define     TEST390_0_NUM_1_BIN    (TEST390_0_NUM_0_BIN + 1872)
#define     TEST390_0_NUM_2_BIN    (TEST390_0_NUM_1_BIN + 1872)
#define     TEST390_0_NUM_3_BIN    (TEST390_0_NUM_2_BIN + 1872)
#define     TEST390_0_NUM_4_BIN    (TEST390_0_NUM_3_BIN + 1872)
#define     TEST390_0_NUM_5_BIN    (TEST390_0_NUM_4_BIN + 1872)
#define     TEST390_0_NUM_6_BIN    (TEST390_0_NUM_5_BIN + 1872)
#define     TEST390_0_NUM_7_BIN    (TEST390_0_NUM_6_BIN + 1872)
#define     TEST390_0_NUM_8_BIN    (TEST390_0_NUM_7_BIN + 1872)
#define     TEST390_0_NUM_9_BIN    (TEST390_0_NUM_8_BIN + 1872)
#define     TEST390_0_NUM_AM_BIN    (TEST390_0_NUM_9_BIN + 1872)
#define     TEST390_0_NUM_DOT_BIN    (TEST390_0_NUM_AM_BIN + 900)
#define     TEST390_0_NUM_PM_BIN    (TEST390_0_NUM_DOT_BIN + 1872)
#define     TEST390_0_BG_BIN    (TEST390_0_NUM_PM_BIN + 900)

const static UI_WidgetTypeDef  icon[] =
{
    [0]     = {
        .x = 0,   .y = 0,    .width = LCD_WIDTH, .hight = LCD_HIGHT,     .addr = TEST390_0_BG_BIN,   .widget_id_type = ICON_BACKGROUND,
    },
    [1]     = {
        .x = 300,   .y = 72,    .width = 30, .hight = 15,     .addr = TEST390_0_NUM_AM_BIN,   .widget_id_type = ICON_WIDGET,
    },

    [2]     = {
        .x = 226,   .y = 92,    .width = 24, .hight = 39,     .addr = TEST390_0_NUM_0_BIN,   .widget_id_type = ICON_WIDGET,
    },
    [3]     = {
        .x = 250,   .y = 92,    .width = 24, .hight = 39,     .addr = TEST390_0_NUM_7_BIN,   .widget_id_type = ICON_WIDGET,
    },

    [4]     = {
        .x = 271,   .y = 92,    .width = 24, .hight = 39,     .addr = TEST390_0_NUM_DOT_BIN,   .widget_id_type = ICON_WIDGET,
    },

    [5]     = {
        .x = 291,   .y = 92,    .width = 24, .hight = 39,     .addr = TEST390_0_NUM_5_BIN,   .widget_id_type = ICON_WIDGET,
    },
    [6]     = {
        .x = 315,   .y = 92,    .width = 24, .hight = 39,     .addr = TEST390_0_NUM_0_BIN,   .widget_id_type = ICON_WIDGET,
    },
};

/* change Here for UI */
UI_MenuTypeDef Test390Menu0 =
{
    /* change Here for UI */
    .name = (const char *)"Test390Menu0",
    .MenuParent = NULL,
    .MenuSub = NULL,
...
static UI_MenuTypeDef *pLocalMenu = &Test390Menu0;
...
static void ButtonCallbackFun(uint8_t type)
{
    ...
    {
        pCurrentMenu->MenuSub = &Test390Menu1;
        pCurrentMenu->destructor_func();
        pCurrentMenu = pCurrentMenu->MenuSub;
        pCurrentMenu->constructor_func(ICON_MIDDLE, NULL);
    }
...
static void TouchCallbackFun(RtkTouchInfo_t *info)
{
    UI_MenuTypeDef *ui_local_right = &Test390Menu1;
    UI_MenuTypeDef *ui_local_left = &Test390Menu1;
    UI_MenuTypeDef *ui_local_cur = pLocalMenu;
    UI_MenuTypeDef *ui_local_down = &Test390Menu1;
    UI_MenuTypeDef *ui_local_up = &Test390Menu1;
