...
{
    [0]     = {
        .x = 0,   .y = 0,    .width = LCD_WIDTH, .hight = LCD_HIGHT,     .addr = EXERCISE_BACKGROUND_BIN,   .widget_id_type = ICON_BACKGROUND,
    },
};

/* change Here for UI */
UI_MenuTypeDef TempTest1 =
{
    /* change Here for UI */
    .name = (const char *)"TempTest1",
    .MenuParent = NULL,
    .MenuSub = NULL,
...
static UI_MenuTypeDef *pLocalMenu = &TempTest1;
...
static void TouchCallbackFun(RtkTouchInfo_t *info)
{
    UI_MenuTypeDef *ui_local_right = &TempTest0;
    UI_MenuTypeDef *ui_local_left = NULL;
