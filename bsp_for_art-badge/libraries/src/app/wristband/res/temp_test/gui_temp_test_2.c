...
{
    [0]     = {
        .x = 0,   .y = 0,    .width = LCD_WIDTH, .hight = LCD_HIGHT,     .addr = SLEEP_BACKGROUND_BIN,   .widget_id_type = ICON_BACKGROUND,
    },
};

/* change Here for UI */
UI_MenuTypeDef TempTest2 =
{
    /* change Here for UI */
    .name = (const char *)"TempTest2",
    .MenuParent = NULL,
    .MenuSub = NULL,
...
static UI_MenuTypeDef *pLocalMenu = &TempTest2;
...
static void TouchCallbackFun(RtkTouchInfo_t *info)
{
    ...
    UI_MenuTypeDef *ui_local_left = &TempTest0;
