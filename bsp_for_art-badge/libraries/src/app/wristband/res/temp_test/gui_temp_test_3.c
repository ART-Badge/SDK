...
{
    [0]     = {
        .x = 0,   .y = 0,    .width = LCD_WIDTH, .hight = LCD_HIGHT,     .addr = MESSAGE_BACKGROUND1_BIN,   .widget_id_type = ICON_BACKGROUND,
    },
};

/* change Here for UI */
UI_MenuTypeDef TempTest3 =
{
    /* change Here for UI */
    .name = (const char *)"TempTest3",
    .MenuParent = NULL,
    .MenuSub = NULL,
...
static UI_MenuTypeDef *pLocalMenu = &TempTest3;
...
static void TouchCallbackFun(RtkTouchInfo_t *info)
{
    ...
    UI_MenuTypeDef *ui_local_down = &TempTest0;
    UI_MenuTypeDef *ui_local_up = NULL;
