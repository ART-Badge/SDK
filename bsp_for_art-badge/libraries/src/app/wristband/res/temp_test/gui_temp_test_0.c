...
/* change Here for UI */
UI_MenuTypeDef TempTest0 =
{
    /* change Here for UI */
    .name = (const char *)"TempTest0",
    .MenuParent = NULL,
    .MenuSub = NULL,
...
static UI_MenuTypeDef *pLocalMenu = &TempTest0;
...
static void TouchCallbackFun(RtkTouchInfo_t *info)
{
    UI_MenuTypeDef *ui_local_right = &TempTest2;
    UI_MenuTypeDef *ui_local_left = &TempTest1;
    UI_MenuTypeDef *ui_local_cur = pLocalMenu;
    UI_MenuTypeDef *ui_local_down = &TempTest4;
    UI_MenuTypeDef *ui_local_up = &TempTest3;
