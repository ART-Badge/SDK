...
#ifndef SPIFFS_DBG
#define SPIFFS_DBG(_f, ...)     //DBG_DIRECT(_f, ## __VA_ARGS__)
#endif
// Set spiffs debug output call for garbage collecting.
#ifndef SPIFFS_GC_DBG
#define SPIFFS_GC_DBG(_f, ...) //DBG_DIRECT(_f, ## __VA_ARGS__)
#endif
// Set spiffs debug output call for caching.
#ifndef SPIFFS_CACHE_DBG
#define SPIFFS_CACHE_DBG(_f, ...) //DBG_DIRECT(_f, ## __VA_ARGS__)
#endif
// Set spiffs debug output call for system consistency checks.
#ifndef SPIFFS_CHECK_DBG
#define SPIFFS_CHECK_DBG(_f, ...) //DBG_DIRECT(_f, ## __VA_ARGS__)
#endif
// Set spiffs debug output call for all api invocations.
#ifndef SPIFFS_API_DBG
#define SPIFFS_API_DBG(_f, ...) //DBG_DIRECT(_f, ## __VA_ARGS__)
#endif
...
#define spiffs_printf(_f, ...)             //DBG_DIRECT(_f, ## __VA_ARGS__)
#endif
