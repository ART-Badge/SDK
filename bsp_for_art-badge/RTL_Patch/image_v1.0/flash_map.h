...
example:
    ...
    3) OTA Bank0:                                   1192K (0x00802000)
        a) OTA Header                    4K (0x00802000)
        b) Secure boot loader            4K (0x0080D000)
        c) Patch code                   40K (0x00803000)
        d) Upperstack  Code            120K (0x0080E000)
        e) APP code                   1024K (0x0082C000)
        f) APP data1                     0K (0x0092C000)
        g) APP data2                     0K (0x0092C000)
        h) APP data3                     0K (0x0092C000)
        i) APP data4                     0K (0x0092C000)
        j) APP data5                     0K (0x0092C000)
        k) APP data6                     0K (0x0092C000)
    4) OTA Bank1:                                      0K (0x0092C000)
    ...
    5) FTL:                                           16K (0x0092C000)
    6) OTA Tmp:                                     1024K (0x00930000)
    7) APP Defined Section:                            0K (0x00A30000)
*/
...
#define OTA_BANK0_SIZE                  0x0012A000  //1192K Bytes
#define OTA_BANK1_ADDR                  0x0092C000
#define OTA_BANK1_SIZE                  0x00000000  //0K Bytes
#define FTL_ADDR                        0x0092C000
#define FTL_SIZE                        0x00004000  //16K Bytes
#define OTA_TMP_ADDR                    0x00930000
#define OTA_TMP_SIZE                    0x00100000  //1024K Bytes
#define BKP_DATA1_ADDR                  0x00A30000
