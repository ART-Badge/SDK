...
static rt_err_t mcu_uart_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    UART_InitStruct.div            = BaudRate_Table[RTL_BAUD_RATE_230400].div;
    UART_InitStruct.ovsr           = BaudRate_Table[RTL_BAUD_RATE_230400].ovsr;
    UART_InitStruct.ovsr_adj       = BaudRate_Table[RTL_BAUD_RATE_230400].ovsr_adj;
