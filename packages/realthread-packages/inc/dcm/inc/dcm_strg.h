...
int dcm_blob_load(struct dcm_pool *pool);
int dcm_blob_unload(struct dcm_pool *pool);
int dcm_blob_store(struct dcm_pool *pool, const char *key, struct dcm_blob *blob);
