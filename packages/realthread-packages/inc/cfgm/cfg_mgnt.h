...
struct cfgm_items
{
    const char *item;
    rt_base_t value;
    rt_err_t (*callback)(const struct cfgm_items *, rt_base_t);
};
...
rt_err_t cfgm_set_system_config(const char *item, rt_base_t value);
rt_err_t cfgm_get_system_config(const char *item, rt_base_t *value);

struct cfgm_object *cfgm_app_get(const char *url);
void cfgm_app_put(struct cfgm_object *app);
rt_err_t cfgm_set_app_config(struct cfgm_object *app, const char *item, rt_base_t value);
rt_err_t cfgm_get_app_config(struct cfgm_object *app, const char *item, rt_base_t *value);
