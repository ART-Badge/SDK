...
public:
    ...
    float m11() { return m_matrix[0][0]; }
    float m12() { return m_matrix[0][1]; }
    float m21() { return m_matrix[1][0]; }
    float m22() { return m_matrix[1][1]; }
    float m31() { return m_matrix[2][0]; }
    float m32() { return m_matrix[2][1]; }
