...
public:
    ...
    virtual void act(unsigned int num)
    {
        ...
        {
            #ifdef PKG_PERSIMMON_USING_LOCAL
            bindChangedS(m_normalList[num]->GetStrName());
            #else
    ...
    virtual void tap(unsigned int num)
    {
        ...
        {
            #ifdef PKG_PERSIMMON_USING_LOCAL
            bindTapS(m_normalList[num]->GetStrName());
            #else
...
protected:
    #ifdef PKG_PERSIMMON_USING_LOCAL
    std::vector<CLocString*> m_normalList;
    #else
    std::vector<std::string> m_normalList;
    #endif
    std::string m_center_suffix;

private:
    Rect set_draw_clip(int area);
