...
int js_generate_snapshot(const jerry_char_t* resource_name_p, size_t resource_name_length,
                         const js_char_t *source_p, size_t source_size,
...
js_value_t js_load_function_snapshot(const uint32_t *function_snapshot_p, const size_t function_snapshot_size);
#endif
